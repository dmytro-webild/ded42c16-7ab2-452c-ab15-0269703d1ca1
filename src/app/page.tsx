...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "Call Now",          href: "tel:+919662777034"},
        {
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/man-holds-phone-front-laptop_482257-85726.jpg",          alt: "Man holds phone in front of laptop"},
        {
          src: "http://img.b2bpic.net/free-photo/young-man-white-t-shirt-showing-winner-gesture-looking-blissful-front-view_176474-89367.jpg",          alt: "Young man in white t-shirt showing winner gesture"},
        {
          src: "http://img.b2bpic.net/free-photo/joyous-person-listening-music-having-fun-dancing_482257-122383.jpg",          alt: "Joyous person listening to music and having fun"},
        {
          src: "http://img.b2bpic.net/free-photo/pleased-indian-guy-cheering-after-winning-game-gaming-console_482257-122195.jpg",          alt: "Pleased indian guy cheering after winning game"},
        {
          src: "http://img.b2bpic.net/free-photo/close-up-shot-pro-gamer-streaming-game-using-headset_482257-121655.jpg",          alt: "Close up shot of pro gamer streaming game"},
      ]}
  ...
  <div id="how-it-works" data-section="how-it-works">
      ...
      metrics={[
        {
          icon: MessageCircle,
          label: "Register",          value: "WhatsApp Us"},
        {
          icon: CreditCard,
          label: "Entry",          value: "Pay ₹20"},
        {
          icon: Star,
          label: "Play",          value: "Win Cash"},
      ]}
  ...
  <div id="tournaments" data-section="tournaments">
      ...
      products={[
        {
          id: "m1",          name: "Free Fire Grand Match",          price: "₹20",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AkqzaM2rM7tfJiTexBhUW2Uqcc/uploaded-1776493412501-141irjci.jpg"},
        {
          id: "m2",          name: "Squad Battle",          price: "₹20",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AkqzaM2rM7tfJiTexBhUW2Uqcc/uploaded-1776493412501-bewsex5k.jpg"},
        {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "4",          title: "Very Smooth",          quote: "The platform is super easy to use, highly recommended.",          name: "Vikram K.",          role: "Pro Player",          imageSrc: "http://img.b2bpic.net/free-photo/man-holding-controller-close-up_23-2149005239.jpg"},
        {
          id: "5",          title: "Fast Support",          quote: "Support team responds quickly via WhatsApp.",          name: "Sunny R.",          role: "Tournament Winner",          imageSrc: "http://img.b2bpic.net/free-photo/close-up-portrait-handsome-young-hipster-man-hazel-eyes-wearing-trendy-plaid-shirt-posing-near-city-cafe_291049-1495.jpg"},
      ]}
      title="Players Say"
  ...
  <div id="gallery" data-section="gallery">
      ...
      features={[
        {
          title: "Tournament Wins",          description: "Winners from daily matches.",          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-man-playing-vr-with-winner-cup-dark-wall_179666-39941.jpg"},
          items: [],
          reverse: false,
        },
        {
          title: "Professional Setup",          description: "Quality match monitoring.",          media: {
  ...
  <div id="safety" data-section="safety">
      ...
      metrics={[
        {
          id: "s1",          icon: ShieldCheck,
          title: "Matches",          value: "100% Fair"},
        {
          id: "s2",          icon: Eye,
          title: "Monitoring",          value: "Manual"},
        {
          id: "s3",          icon: AlertTriangle,
          title: "Hacks",          value: "Forbidden"},
        {
          id: "s4",          icon: Smartphone,
          title: "Payouts",          value: "Instant"},
      ]}
      ...
      columns={[
        {
          title: "Quick Links",          items: [
            ...
            {
              label: "Fair Play Policy",              href: "#safety"},
            {
              label: "WhatsApp Support",              href: "https://wa.me/919662777034"},
          ],
        },
        {
          title: "Social",          items: [
            {
              label: "Instagram",              href: "https://instagram.com/hb_tournaments"},
            {
              label: "Telegram",              href: "#"},
          ],
        },
